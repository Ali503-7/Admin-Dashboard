...
const EmailAside = () => {
  ...
  return (
    <div className="xl:min-w-[260px] xl:translate-x-0 translate-x-full overflow-hidden w-0 border-r border-r-Light-Other-Ouline_Border dark:border-r-Dark-Other-Ouline_Border">
      <div className="p-5">
