...
const WeeklySales = () => {
  ...
  return (
    <div className="lg:col-span-4 sm:col-span-4  bg-Light-Other-Paper_Card dark:bg-Dark-Other-Paper_Card shadow-Light_6 dark:shadow-Dark_6 flex flex-col justify-between p-5 rounded-md relative">
      <div>
