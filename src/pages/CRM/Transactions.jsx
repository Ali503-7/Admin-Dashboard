...
const Transactions = () => {
  return (
    <div className="col-span-8 bg-Light-Other-Paper_Card dark:bg-Dark-Other-Paper_Card shadow-Light_6 dark:shadow-Dark_6 flex flex-col justify-between p-5 relative">
      <div className="text-Light-Text-Primary dark:text-Dark-Text-Primary H6">
        Transactions
      </div>
